...
const FlyingPosterWatched = () => {
  const { animatingMovie, onAnimationComplete } = useWatched()
  ...
  useEffect(() => {
    ...
    if (animatingMovie) {
      ...
      // Находим позицию пункта "Просмотренное" в меню
      const watchedElement = document.querySelector('[data-menu-id="watched"]')
      if (watchedElement) {
...
export default FlyingPosterWatched